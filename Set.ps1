...
$CoreModules = "tmf_base,tmf_party,tmf_customer,tmf_product_catalog,tmf_product_ordering,tmf_service_inventory,tmf_resource_inventory,tmf_trouble_ticket,tmf_billing_management,tmfc001_wiring,tmfc002_wiring,tmfc005_wiring,tmfc020_wiring,tmfc022_wiring,tmfc023_wiring,tmfc027_wiring,tmfc028_wiring,tmfc031_wiring"
