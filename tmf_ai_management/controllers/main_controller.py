...
API_BASE = "/tmf-api/AiM/v4"
RESOURCE_MODEL = "tmf.ai.management.resource"
NON_PATCHABLE = {"id", "href"}
RESOURCES = set(('aiContractSpecification','aiModel','aiModelSpecification','aiContract','aiContractViolation','alarm','rule','monitor','topic'))
LISTENER_EVENTS = set(('aiContractSpecificationCreateEvent','aiContractSpecificationDeleteEvent','aiContractSpecificationAttributeValueChangeEvent','aiModelCreateEvent','aiModelAttributeValueChangeEvent','aiModelStateChangeEvent','aiModelDeleteEvent','aiModelSpecificationCreateEvent','aiModelSpecificationDeleteEvent','aiModelSpecificationAttributeValueChangeEvent','aiContractCreateEvent','aiContractAttributeValueChangeEvent','aiContractStateChangeEvent','aiContractDeleteEvent','aiContractViolationCreateEvent','aiContractViolationAttributeValueChangeEvent','aiContractViolationDeleteEvent','alarmCreateEvent','alarmAttributeValueChangeEvent','alarmStateChangeEvent','alarmDeleteEvent','ruleCreateEvent','ruleAttributeValueChangeEvent','ruleStateChangeEvent','ruleDeleteEvent','eventCreateEvent','monitorCreateEvent','monitorAttributeValueChangeEvent','monitorStateChangeEvent','monitorDeleteEvent','topicCreateEvent','topicChangeEvent','topicDeleteEvent'))
...
class TMFController(http.Controller):
    ...
    def register_listener(self, **_params):
        ...
        rec = request.env["tmf.hub.subscription"].sudo().create(
            {
                "name": "tmf_ai_management-" + api_name + "-" + callback,
                "api_name": api_name,
                "callback": callback,
                "query": query,
                "event_type": "any",
    ...
    def openid_userinfo(self, **_params):
        if "tmf_ai_management" != "tmf_self_care_management":
