...
class TMFUiNormalizer(models.AbstractModel):
    ...
    _EXACT_MENU_DOMAIN_MAP = {
        ...
        "billing account management": "billing_revenue",
        "association": "inventory_resource",
        "resource association": "inventory_resource",
        "cloud application": "platform_identity",
        "platform cloud application": "platform_identity",
        "ogw applications": "platform_identity",
        "platform ogw applications": "platform_identity",
        "products": "catalog",
        "catalog products": "catalog",
        "recommendation management": "orders_sales",
        "sales recommendation management": "orders_sales",
        "service usage": "assurance",
        "tmf service usage assurance": "assurance",
        ...
        "usage billing": "billing_revenue",
        "usage consumption": "billing_revenue",
        "tmf677 usage consumption billing": "billing_revenue",
        "user equipment": "inventory_resource",
        "resource user equipment": "inventory_resource",
        "user equipment spec": "inventory_resource",
        "resource user equipment specification": "inventory_resource",
        "user info": "customer_party",
        "customer user info": "customer_party",
        "warranty": "catalog",
