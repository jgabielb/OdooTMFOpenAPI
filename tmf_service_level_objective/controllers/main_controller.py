...
class TMFServiceLevelObjectiveController(TMFBaseController):
    ...
    def serviceLevelObjective_collection(self, **kw):
        if request.httprequest.method == "POST":
            return self._tmf_do_create(RESOURCES["serviceLevelObjective"])
        return self._tmf_do_list(RESOURCES["serviceLevelObjective"], **kw)
    ...
    def serviceLevelObjective_individual(self, rid, **kw):
        return self._tmf_do_individual(RESOURCES["serviceLevelObjective"], rid, **kw)
