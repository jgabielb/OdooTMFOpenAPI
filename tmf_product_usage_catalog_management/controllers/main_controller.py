...
class TMFProductUsageCatalogManagementController(TMFBaseController):
    ...
    def productUsageSpecification_collection(self, **kw):
        if request.httprequest.method == "POST":
            return self._tmf_create("productUsageSpecification")
        return self._tmf_list("productUsageSpecification", **kw)
    ...
    def productUsageSpecification_individual(self, rid, **kw):
        return self._tmf_individual("productUsageSpecification", rid, **kw)
