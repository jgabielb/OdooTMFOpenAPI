...
class TMFModel(models.Model):
    _name = 'tmf.test.data.instance.definition'
    _description = 'TestDataInstanceDefinition'
    ...
    def _get_tmf_api_path(self):
        return "/test_data_instance_definitionManagement/v4/TestDataInstanceDefinition"
    ...
    def to_tmf_json(self):
        ...
        return {
            "id": self.tmf_id,
            "href": self.href,
            "@type": "TestDataInstanceDefinition",
    ...
    def create(self, vals_list):
        ...
        for rec in recs:
            self._notify('testDataInstanceDefinition', 'create', rec)
        return recs

    def write(self, vals):
        res = super().write(vals)
        for rec in self:
            self._notify('testDataInstanceDefinition', 'update', rec)
        return res
        ...
        for resource in payloads:
            try:
                self.env['tmf.hub.subscription']._notify_subscribers(
                    api_name='testDataInstanceDefinition',
                    event_type='delete',
