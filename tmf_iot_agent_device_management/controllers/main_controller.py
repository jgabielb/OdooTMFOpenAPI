...
RESOURCE_MODEL = "tmf.iot.agent.device.resource"
NON_PATCHABLE = {"id", "href"}
RESOURCES = set(('iotDevice','dataAccessEndpoint','iotDeviceSpecification','iotDataEvent','iotManagementEvent','resourceSpecification','alarm'))
LISTENER_EVENTS = set(('iotDeviceCreateEvent','iotDeviceChangeEvent','iotDeviceBatchEvent','iotDeviceDeleteEvent','iotDeviceHeartBeatEvent','iotDeviceStateChangeEvent','iotDeviceSpecificationCreateEvent','iotDeviceSpecificationChangeEvent','iotDeviceSpecificationBatchEvent','iotDeviceSpecificationDeleteEvent','resourceSpecificationCreateEvent','resourceSpecificationChangeEvent','resourceSpecificationBatchEvent','resourceSpecificationDeleteEvent','alarmCreateEvent','alarmChangeEvent','alarmDeleteEvent'))
...
class TMFController(http.Controller):
    ...
    def register_listener(self, **_params):
        ...
        rec = request.env["tmf.hub.subscription"].sudo().create(
            {
                "name": "tmf_iot_agent_device_management-" + api_name + "-" + callback,
                "api_name": api_name,
                "callback": callback,
                "query": query,
                "event_type": "any",
    ...
    def openid_userinfo(self, **_params):
        if "tmf_iot_agent_device_management" != "tmf_self_care_management":
