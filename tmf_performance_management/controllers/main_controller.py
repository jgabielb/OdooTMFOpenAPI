...
RESOURCE_MODEL = "tmf.performance.management.resource"
...
class TMF628Controller(http.Controller):
    ...
    def register_listener(self, **_params):
        ...
        api_name = "performanceMeasurement"
        ...
        rec = request.env["tmf.hub.subscription"].sudo().create(
            {
                "name": f"tmf628-{api_name}-{callback}",
                "api_name": api_name,
                "callback": callback,
                "query": query,
                "event_type": "any",
