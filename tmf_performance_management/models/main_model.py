...
class TMFPerformanceResource(models.Model):
    _name = "tmf.performance.management.resource"
    _description = "TMF628 Performance Management Resource"
    ...
    def _get_tmf_api_path(self):
        self.ensure_one()
        return "/tmf-api/performance/v5/%s" % (self.resource_type or "performanceMeasurement")
    ...
    def to_tmf_json(self):
        ...
        payload["@type"] = self.tmf_type_value or payload.get("@type") or "PerformanceResource"
        if self.base_type:
