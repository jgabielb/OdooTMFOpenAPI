...
RESOURCE_MODEL = "tmf.naas.resource"
NON_PATCHABLE = {"id", "href"}
RESOURCES = set(('service','monitor','serviceCatalog','serviceCategory','serviceCandidate','serviceSpecification','serviceOrder','cancelServiceOrder','checkServiceQualification','queryServiceQualification','serviceProblem','serviceProblemEventRecord','problemAcknowledgement','problemUnacknowledgement','serviceTest','serviceTestSpecification','usageConsumptionReportRequest','usageConsumptionReport'))
LISTENER_EVENTS = set(('serviceCreateEvent','serviceAttributeValueChangeEvent','serviceStateChangeEvent','serviceDeleteEvent','monitorCreateEvent','monitorAttributeValueChangeEvent','monitorStateChangeEvent','monitorDeleteEvent'))
...
class TMFController(http.Controller):
    ...
    def register_listener(self, **_params):
        ...
        rec = request.env["tmf.hub.subscription"].sudo().create(
            {
                "name": "tmf_network_as_a_service_management-" + api_name + "-" + callback,
                "api_name": api_name,
                "callback": callback,
                "query": query,
                "event_type": "any",
    ...
    def openid_userinfo(self, **_params):
        if "tmf_network_as_a_service_management" != "tmf_self_care_management":
