...
|----------|------------------------------------------------|--------|-----------------------|
| TMFC001  | ProductCatalogManagement                       | ⚠️ | `tmfc001_wiring` resolves TMF633/634/632/669/651/673/674/675 refs into `tmf_product_catalog` models. `tmf_product_catalog` exposes productSpecification, productOffering, productOfferingPrice and publishes core TMF620 events in models/controllers. Full TMF620 resource coverage (`catalog`, `category`, `importJob`, `exportJob`) and subscribed-event callback handling for TMF633/TMF632/TMF669 were not evidenced. |
