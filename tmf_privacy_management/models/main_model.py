...
class TMFPrivacyResource(models.Model):
    _name = "tmf.privacy.management.resource"
    _description = "TMF644 Privacy Management Resource"
    ...
    def _get_tmf_api_path(self):
        self.ensure_one()
        return "/tmf-api/privacyManagement/v5/%s" % (self.resource_type or "partyPrivacyProfile")
    ...
    def to_tmf_json(self):
        ...
        payload["@type"] = self.tmf_type_value or payload.get("@type") or "PartyPrivacyProfile"
        if self.base_type:
