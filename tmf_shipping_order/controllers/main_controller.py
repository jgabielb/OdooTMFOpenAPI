...
class TMFShippingOrderController(TMFBaseController):
    ...
    def shippingOrder_collection(self, **kw):
        if request.httprequest.method == "POST":
            return self._tmf_do_create(RESOURCES["shippingOrder"])
        return self._tmf_do_list(RESOURCES["shippingOrder"], **kw)
    ...
    def shippingOrder_individual(self, rid, **kw):
        return self._tmf_do_individual(RESOURCES["shippingOrder"], rid, **kw)
