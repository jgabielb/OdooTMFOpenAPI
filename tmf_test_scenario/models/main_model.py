...
class TMFTestScenario(models.Model):
    _name = "tmf.test.scenario"
    _description = "TMF709 TestScenario"
    ...
    test_scenario_definition_json = fields.Text(string="testScenarioDefinition")
    ...
    def _get_tmf_api_path(self):
        return "/testScenario/v4/testScenario"
    ...
    def to_tmf_json(self):
        ...
        return {
            ...
            "state": self.state,
            "testScenarioDefinition": _loads(self.test_scenario_definition_json),
            "@type": self.tmf_type_value or "TestScenario",
    ...
    def from_tmf_json(self, data, partial=False):
        ...
        if "testScenarioDefinition" in data:
            vals["test_scenario_definition_json"] = _dumps(data.get("testScenarioDefinition"))
        return vals
